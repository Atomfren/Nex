...
class ResourcepacksPage(QWidget):
    """Страница ресурспаков."""
    ...
    def _create_ui(self):
        ...
        content = QLabel(
            ...
            "• Установите ресурспак, переместив файл .zip в папку resourcepacks инстанса\n"
            "• Или нажмите 'Открыть папку' для ручного управления"
        )
        ...
        open_btn = QPushButton("📂 Открыть папку resourcepacks")
        ...
        """)
        open_btn.clicked.connect(self._open_resourcepacks)
    ...
    def _open_resourcepacks(self):
        ...
        if instance_name == "Нет инстансов":
            ...
            return
        path = get_instances_dir() / instance_name / ".minecraft" / "resourcepacks"
