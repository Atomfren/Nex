...
class ShadersPage(QWidget):
    ...
    def _create_ui(self):
        ...
        content = QLabel(
            ...
            "• Установите шейдеры, переместив файлы в папку shaderpacks инстанса\n"
        ...
        open_btn = QPushButton("📂 Открыть папку shaderpacks")
        ...
        """)
        open_btn.clicked.connect(self._open_shaders)
    ...
    def _open_shaders(self):
        ...
        if instance_name == "Нет инстансов":
            ...
            return
        path = get_instances_dir() / instance_name / ".minecraft" / "shaderpacks"
